...
\begin{figure}
	...
	\subfigure[]{
	\copyrightbox[b]{
		\includegraphics[height=0.28\linewidth]{mychapters/chapter-2/figs/PrecessionOfATop}	
...
خارجی $B_0$ قرار می‌گیرند، دو اتفاق مهم می‌افتد: اولا ممان های مغناطیسی اتم ها تمایل پیدا می‌کنند که\textit{هم‌جهت} یا \textit{خلاف جهت} 
...
به طور دقیق تر تعداد پروتون‌های همجهت ($N_\text{down}$) و خلاف جهت میدان ($N_\text{up}$)، از رابطه‌‌ی زیر ناشی میشود.
...
\begin{figure}
	\centering
	\copyrightbox[b]{
		\includegraphics[width=0.6\linewidth]{mychapters/chapter-2/figs/Energy-absorption}
	}{\scriptsize\Doi{10.1002/9781119013068}}
	\caption{}
...
\begin{figure}
	...
	\subfigure[]{
		\copyrightbox[b]{
			\includegraphics[width=0.3\linewidth]{mychapters/chapter-2/figs/rotating-axis}
	...
	\subfigure[]{
		\copyrightbox[b]{
			\includegraphics[width=0.6\linewidth]{mychapters/chapter-2/figs/rotating-frame}
...
\begin{figure}
	...
	\copyrightbox[b]{
		\begin{minipage}{0.9\linewidth}\centering
			\begin{RTL}
			\subfigure[]{
				\includegraphics[width=0.25\linewidth]{mychapters/chapter-2/figs/rot-a}\label{subfig:rot-a}}
			\hspace{0.075\linewidth}
			\subfigure[]{
				\includegraphics[width=0.25\linewidth]{mychapters/chapter-2/figs/rot-b}\label{subfig:rot-b}}
			\hspace{0.075\linewidth}
			\subfigure[]{
				\includegraphics[width=0.25\linewidth]{mychapters/chapter-2/figs/rot-c}\label{subfig:rot-c}}
			\end{RTL}
		\end{minipage}
	}{\scriptsize\Doi{10.1017/9781107706958.010}}
\end{figure}
...
که در آن $B_1$ اندازه‌ی میدان مغناطیسی سیگنال $RF$ است و $t_p$ طول زمان اعمال پالس است. اگر پالس \lr{RF} درست در زمانی که $M_0$ به صفحه‌ی مولفه‌‌ی عمودی برسد پایان بیابد، $\alpha=90\degree$ می‌شود و پالس \lr{RF} یک \textbf{پالس $90\degree$} نامیده می‌شود. اگر قدرت و یا طول مدت اعمال این سیگنال دوبرابر شود، بردار $M_0$ دقیقا $180\degree$ می‌چرخد و پالس متناظر با آن را \textbf{پالس $180\degree$} می‌نامند. بنابراین زمان اهمیت ویژه‌ای در اساس کار دستگاه‌های \mri دارد
\cite{McRobbie}.
...
همچنین پالس \lr{RF} یک اثر مهم دیگری که بر‌روی اسپین ها دارد این است که آن‌ها را هم‌فاز می‌کند. به عبارت‌ دیگر تمام آن ها در روی دایره ی گردان، به یک نقطه اشاره می‌کنند. شکل \ref{fig:rotating-axis-coil} خلاصه‌ای از آن‌چه که گفته شد را نشان می‌دهد.
 ...
 \begin{figure}
 	\centering
 	\includegraphics[width=0.8\linewidth]{mychapters/chapter-2/figs/signal-recived}
 	\caption{}
...
\begin{figure}
	\centering
	\copyrightbox[b]{
		\includegraphics[width=0.9\linewidth]{mychapters/chapter-2/figs/HRMN6}
