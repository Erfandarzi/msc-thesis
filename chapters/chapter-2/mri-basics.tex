...
\FloatBarrier
\subsection{مسیرهای نمونه‌برداری}
نمونه برداری \kspace مسیر
\LTRfootnote{Trajectoy}
های متفاوتی می‌تواند داشته باشد.
\cite{Review-trajectory-2013}



\begin{center}
	\begin{longtable}{>{\raggedleft\arraybackslash}p{0.18\linewidth}lp{0.4\linewidth}}
		\caption{مسیر‌های نمونه برداری} \label{tab:trajectories} \vspace{-1em} \\
		
		\hline \multicolumn{1}{c}{\textbf{نام}} & \multicolumn{1}{c}{\textbf{شماتیک}} & \multicolumn{1}{c}{\textbf{توضیحات}} \\ \hline 
		\endfirsthead
		
		\multicolumn{3}{c}%
		{{\bfseries \tablename\ \thetable{}: ادامه‌ی جدول مسیر‌های نمونه برداری}} \\
		\hline \multicolumn{1}{c}{\textbf{نام}} & \multicolumn{1}{c}{\textbf{شماتیک}} & \multicolumn{1}{c}{\textbf{توضیحات}} \\ \hline 
		\endhead
		...
		\lr{Cartesian-raster trajectory with equal space lines} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/trajectory-cartesian-equal-space-lines.png}} & \\		
		\lr{Cartesian-raster trajectory with variable density} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/trajectory-cartesian-variable-density.png}} & \\
		\lr{Zigzag-shaped trajectory with constant phase-encoding gradients} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/trajectory-Zigzag-shaped-constant-phase-encoding-gradients.png}} & \\
		\lr{Zigzag-shaped trajectory with blipped phase-encoding gradients} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/trajectory-Zigzag-shaped-blipped-phase-encoding-gradients.png}} & \\
		\lr{Typically radial trajectory with oversampling in k-space center} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/Typically-radial-trajectory-with-oversampling-in-k-space-center.png}} & \\
		\lr{Spiral trajectory through k-space with uniform density} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/Spiral-trajectory-through-k-space-with-uniform-density.png}} & \\
		\lr{Stochastic trajectory consist of many arbitrary k-space lines} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/Stochastic-trajectory-consist-of-many-arbitrary-k-space-lines.png}} & \\
		\lr{Rosette trajectory scheme through k-space with many crossings} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/Rosette-trajectory-scheme-through-k-space-with-many-crossings.png}} & \\
		\lr{Circular trajectory with continuous sampling in each circle} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/Circular-trajectory-with-continuous-sampling-in-each-circle.png}} & \\
		\lr{PROPELLER trajectory scheme like a blade rotate about the k-space} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/PROPELLER-trajectory-scheme-like-a-blade-rotate-about-the-kspace.png}} & \\
		\lr{WHIRL trajectory with better rotation performance} & \raisebox{-\totalheight}{\includegraphics[width=0.35\linewidth]{chapters/chapter-2/figs/WHIRL-trajectory-with-better-rotation-performance.png}} & \\
	\end{longtable}
\end{center}
