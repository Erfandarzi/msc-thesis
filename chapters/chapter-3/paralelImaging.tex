...
\begin{figure}
	...
	\subfigure[]{
		\includegraphics[width=0.3\linewidth]{chapters/chapter-3/figs/SMASH-rec-coils-0}
		\label{subfig:smash-rec-coils-0}}
	\hfill
	\subfigure[]{
		\includegraphics[width=0.3\linewidth]{chapters/chapter-3/figs/SMASH-rec-coils-1}
		\label{subfig:smash-rec-coils-1}}
	\hfill
	\subfigure[]{
		\includegraphics[width=0.3\linewidth]{chapters/chapter-3/figs/SMASH-rec-coils-pe}
